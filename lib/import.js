  ...
  Import.prototype = {
    ...
    start: function() {
      ...
      importUsers: function(next) {
        ...
        'bbcode-to-md': (function(){
          var
          r0 = [/\[quote\s+author=(.*) link.*\](.*)\[\/quote\]\s*/gmi, function(str, arg1, arg2) {
              var s = "\n";
              if (arg1) {
                  s += "@" + arg1 + " said:\n";
              }
              ...
              return s;
          }], //quote; replace [quote author=name ] quote [/quote] with "\n @name said: \n > quote \n"
          ...
          r2 = [/\[size.*\](.*)\[\/size\]\s*/gmi, "$1"],
          r3 = [/\[embed\s*\](.*)\[\/embed\]\s*/gmi, " $1 "],
          ...
          r23 = [/<br\s*(\/)?>/gmi, "\n"],
          r24 = [/\[youtube\](.*)\[\/youtube\]\s*/gmi, "( youtube: $1 )"],
          r24a = [/\[soundcloud\](.*)\[\/soundcloud\]\s*/gmi, " ( soundcloud: $1 )"],
          r24b = [/\[vimeo\](.*)\[\/vimeo\]\s*/gmi, "( vimeo: $1 )"],
          r25 = [/\[hr\]/gmi, "\n - - - \n"],
          r26 = [/\[time\](.*)\[\/time\]\s*/gmi, function(str, arg1) {
              var s = "";
              if (arg1) {
                  arg1 = parseInt(arg1, 10);
                  s += arg1 > 0 ? " " + new Date(arg1 * 1000).toLocaleString() + " " : "";
              }
              return s;
          }];
              return function(str){
          ...
          .replace(r23[0], r23[1])
          .replace(r24[0], r24[1])
          .replace(r24a[0], r24a[1])
          .replace(r24b[0], r24b[1])
          .replace(r25[0], r25[1])
          .replace(r26[0], r26[1]);
